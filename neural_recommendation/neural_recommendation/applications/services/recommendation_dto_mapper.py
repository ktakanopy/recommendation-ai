...
class RecommendationDtoMapper:
    ...
    def to_recommendation_result_response_dict(result: RecommendationResult) -> Dict[str, Any]:
        ...
        recommendations = [
            RecommendationDtoMapper.to_recommendation_response_dict(rec) for rec in result.recommendations
        ]
    ...
    def rating_requests_to_domain(rating_requests: List) -> List[Rating]:
        ...
        return [RecommendationDtoMapper.rating_request_to_domain(rating_req) for rating_req in rating_requests]
