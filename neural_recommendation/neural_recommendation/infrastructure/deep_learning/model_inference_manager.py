...
class ModelInferenceManager:
    ...
    def __init__(self, models_dir: str = "models", device: str = "cpu", data_dir: str = "data", processed_data_dir: str = "data/processed_data"):
    ...
    def load_model_and_features(
        ...
        logger.info(f"Loading feature information from {os.path.join(self.processed_data_dir, features_filename)}")
        self._feature_info = FeatureInfoDto.load(os.path.join(self.processed_data_dir, features_filename))
