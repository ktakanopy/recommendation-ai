...
class TestRecommendationService:
    ...
    def recommendation_service(self, mock_ncf_model, mock_feature_processor, movie_mappings):
        ...
        with patch('neural_recommendation.domain.services.recommendation_service.CandidateGenerator') as mock_cg_class, \
             patch('neural_recommendation.domain.services.recommendation_service.ColdStartRecommender') as mock_csr_class:
    ...
    def test_generate_recommendations_for_training_user_success(self, recommendation_service, mock_feature_processor, mock_ncf_model):
    ...
    def test_generate_recommendations_cold_start_with_user_ratings(self, recommendation_service, mock_cold_start_recommender):
    ...
    def test_generate_recommendations_cold_start_without_ratings(self, recommendation_service, mock_cold_start_recommender):
